     ...
     <div className='fondoiniciojajaNP'>
        ...
        <div className="DerechaInicioNP">
            ...
            <div className="MapaInicioNP">
                ...
                <Link to="/nivel_2_parte1" className="btn button5 type1">
                            ¡VAMOS!
                </Link>
                </Card>  
                </div>
                ...
                <Link to="/nivel_2_parte2" className="btn button5 type1">
                            ¡VAMOS!
                </Link>
                </Card>  
                </div>
            ...
            <Card className="TituloMapaInicioNP" style={{ width: '15rem', height: '27rem' }}>
                ...
                <Link to="/nivel_2_parte3" className="btn button5 type1">
                    ¡VAMOS!
                    </Link>
                </Card> 
                </div>
